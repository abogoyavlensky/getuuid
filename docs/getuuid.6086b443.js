...
})({"lLiO3":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "56a50b466086b443";
"use strict";
...
},{}],"d2nWM":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>uuidGenerator);
    ...
    return {
            ...
            try {
                switch(this.selectedType){
                    ...
                    case 'v7':
                        ...
                        break;
                    case 'ulid':
                        newUuid = (0, _ulid.ulid)();
                        break;
                    case 'nanoid':
                        newUuid = (0, _nanoid.nanoid)();
                        break;
                    default:
                        newUuid = _uuid.v4();
                }
        ...
        copyToClipboard (text, buttonId = 'main') {
            navigator.clipboard.writeText(text).then(()=>{
                ...
                if (buttonId === 'main') this.copied = true;
                setTimeout(()=>{
                    this.copiedItems[buttonId] = false;
                    if (buttonId === 'main') this.copied = false;
                }, 2000);
            });
        },
...
},{"uuid":"f1qTK","ulid":"3rzV8","nanoid":"328Fw","alpinejs":"144A4","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"f1qTK":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"9xbEn":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./md5.js":"hhNhp","./v35.js":"iruG5","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"hhNhp":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
function md5(bytes) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"iruG5":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./parse.js":"9yQPA","./stringify.js":"9dsAN","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"7Sd5x":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./sha1.js":"glDwi","./v35.js":"iruG5","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"glDwi":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
function f(s, x, y, z) {
    switch(s){
...
},{"./validate.js":"3wmxZ","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"3rzV8":[function(require,module,exports,__globalThis) {
// These values should NEVER change. The values are precisely for
// generating ULIDs.
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "MAX_ULID", ()=>MAX_ULID);
parcelHelpers.export(exports, "MIN_ULID", ()=>MIN_ULID);
parcelHelpers.export(exports, "TIME_LEN", ()=>TIME_LEN);
parcelHelpers.export(exports, "TIME_MAX", ()=>TIME_MAX);
parcelHelpers.export(exports, "ULIDError", ()=>ULIDError);
parcelHelpers.export(exports, "ULIDErrorCode", ()=>ULIDErrorCode);
parcelHelpers.export(exports, "decodeTime", ()=>decodeTime);
parcelHelpers.export(exports, "encodeTime", ()=>encodeTime);
parcelHelpers.export(exports, "fixULIDBase32", ()=>fixULIDBase32);
parcelHelpers.export(exports, "incrementBase32", ()=>incrementBase32);
parcelHelpers.export(exports, "isValid", ()=>isValid);
parcelHelpers.export(exports, "monotonicFactory", ()=>monotonicFactory);
parcelHelpers.export(exports, "ulid", ()=>ulid);
parcelHelpers.export(exports, "ulidToUUID", ()=>ulidToUUID);
parcelHelpers.export(exports, "uuidToULID", ()=>uuidToULID);
var global = arguments[3];
...
function crockfordEncode(input) {
    ...
    if (bitsRead > 0) output.unshift(buffer & 0x1f);
...
function crockfordDecode(input) {
    ...
    for (const character of sanitizedInput){
        ...
        if (byte === -1) throw new Error(`Invalid base 32 character found in string: ${character}`);
        buffer |= byte << bitsRead;
        bitsRead += 5;
        while(bitsRead >= 8){
 ...
 */ function decodeTime(id) {
    if (id.length !== TIME_LEN + RANDOM_LEN) throw new ULIDError(ULIDErrorCode.DecodeTimeValueMalformed, "Malformed ULID");
    const time = id.substr(0, TIME_LEN).toUpperCase().split("").reverse().reduce((carry, char, index)=>{
        const encodingIndex = ENCODING.indexOf(char);
        if (encodingIndex === -1) throw new ULIDError(ULIDErrorCode.DecodeTimeInvalidCharacter, `Time decode error: Invalid character: ${char}`);
        return carry += encodingIndex * Math.pow(ENCODING_LEN, index);
    }, 0);
    if (time > TIME_MAX) throw new ULIDError(ULIDErrorCode.DecodeTimeValueMalformed, `Malformed ULID: timestamp too large: ${time}`);
    return time;
}
/**
 ...
 */ function detectPRNG(root) {
    ...
    else if (typeof globalCrypto?.randomBytes === "function") return ()=>globalCrypto.randomBytes(1).readUInt8() / 0xff;
 ...
 */ function encodeTime(now, len = TIME_LEN) {
    ...
    else if (now > TIME_MAX) throw new ULIDError(ULIDErrorCode.EncodeTimeSizeExceeded, `Cannot encode a time larger than ${TIME_MAX}: ${now}`);
 ...
 */ function ulidToUUID(ulid) {
    ...
    if (!isValid) throw new ULIDError(ULIDErrorCode.ULIDInvalid, `Invalid ULID: ${ulid}`);
 ...
 */ function uuidToULID(uuid) {
    ...
    if (!isValid) throw new ULIDError(ULIDErrorCode.UUIDInvalid, `Invalid UUID: ${uuid}`);
    const bytes = uuid.replace(/-/g, "").match(/.{1,2}/g);
    if (!bytes) throw new ULIDError(ULIDErrorCode.Unexpected, `Failed parsing UUID bytes: ${uuid}`);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"144A4":[function(require,module,exports,__globalThis) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["lLiO3","d2nWM"], "d2nWM", "parcelRequire94c2", {})

//# sourceMappingURL=getuuid.6086b443.js.map
